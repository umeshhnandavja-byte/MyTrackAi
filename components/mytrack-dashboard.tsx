...
const nav = [[LayoutDashboard, 'Dashboard'], [ListChecks, 'Tasks'], [Inbox, 'To-Do'], [Map, 'Planning Board'], [BarChart3, 'Analysis'], [CalendarDays, 'Calendar'], [Settings, 'Settings']] as const
